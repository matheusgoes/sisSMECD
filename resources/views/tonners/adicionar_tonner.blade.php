...
@section('content')
  <div class="box" style="padding: 10px;">
    ...
    <div id="erro"></div>
    <form name="submit_form" class="form" action="{{ URL::to('/tonners/cadastrar') }}" onsubmit="return validateForm()"  method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
        <table>
          <tr>
            <td> <br> </td>
          ...
          <tr>
            ...
            <td><input class="form-control-plaintext col-xs-12"  type="text" name="modelo" placeholder="Modelo (Obrigatório)"></td>
          </tr>
          <tr>
            <td> <br> </td>
          </tr>
          <tr>
              ...
              <td><input class="form-control-plaintext col-xs-12"  type="text" name="escola" placeholder="Escola (Obrigatório)"></td>
          </tr>
          <tr>
            <td> <br> </td>
          </tr>
          <tr>
              ...
              <td><input  class="form-control-plaintext col-xs-6" type="text" name=quantidade placeholder="Quantidade (Obrigatório)"></td>
          </tr>
          <tr>
            <td> <br> </td>
          </tr>
